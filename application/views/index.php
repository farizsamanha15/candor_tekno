...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Candor</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#portfolio">Barang</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">Cara Pesan</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#team">TESTIMONI</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="<?php echo base_url().'assets/img/portfolio/kaos.png'?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Kaos</h4>
              <p class="text-muted">Terhubung dengan vendor kaos</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
              ...
              <img class="img-fluid" src="<?php echo base_url().'assets/img/portfolio/kemeja.png'?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Kemeja</h4>
              <p class="text-muted">Terhubung dengan vendor kemeja</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              ...
              <p class="text-muted">Terhubung dengan vendor seragam</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
              ...
              <img class="img-fluid" src="<?php echo base_url().'assets/img/portfolio/jersey.png'?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Jersey</h4>
              <p class="text-muted">Terhubung dengan vendor jersey</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
              ...
              <img class="img-fluid" src="<?php echo base_url().'assets/img/portfolio/jaket.png'?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Jaket</h4>
              <p class="text-muted">Terhubung dengan vendor jaket</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal6">
              ...
              <img class="img-fluid" src="<?php echo base_url().'assets/img/portfolio/parka.png'?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Parka</h4>
              <p class="text-muted">Terhubung dengan vendor Parka</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Candor memberikan fasilitas kepada pengguna untuk melakukan pemesanan <br>dan terhubung langsung dengan vendor</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
              ...
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>
            Cari Barang dan memilih barang
            </h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Kamu dapat mencari jenis pakaian yang kamu inginkan dengan masuk ke tampilan katalog Candor. Kemudian anda dapat memilih vendor.</p>
                  </div>
                </div>
              </li>
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>
            Memasukkan informasi <br>
              terkait pemesanan
            </h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Setelah memilih vendor, memasukkan beberapa data terkait pemesanan. </p>
                  </div>
                </div>
              </li>
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>
            Melakukan Review dan melakukan pembayaran
            </h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Kamu wajib melengkapi alamat pengiriman barang pada halaman shopping review dan melakukan pembayaran</p>
                  </div>
                </div>
              </li>
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>Monitoring progress produk <br> yang dipesan</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Anda dapat melakukan monitoring barang yang anda pesan</p>
                  </div>
                </div>
              </li>
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>
            Menerima barang dan konfirmasi
            </h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Kamu dapat mencari jenis pakaian yang kamu inginkan dengan masuk ke tampilan katalog Candor. Kemudian anda dapat memilih vendor.</p>
